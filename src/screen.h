...
extern void pw_screen_draw_img(pw_img_t *img, pw_screen_pos_t x, pw_screen_pos_t y);
extern void pw_screen_clear_area(pw_screen_pos_t x, pw_screen_pos_t y, pw_screen_dim_t width, pw_screen_dim_t height);
extern void pw_screen_draw_horiz_line(
    pw_screen_pos_t x, pw_screen_pos_t y, pw_screen_dim_t len, pw_screen_color_t color);
extern void pw_screen_draw_text_box(
    pw_screen_pos_t x1, pw_screen_pos_t y1, pw_screen_pos_t x2, pw_screen_pos_t y2, pw_screen_color_t color);
extern void pw_screen_clear();
extern void pw_screen_fill_area(
    pw_screen_pos_t x, pw_screen_pos_t y, pw_screen_dim_t w, pw_screen_dim_t h, pw_screen_color_t color);
