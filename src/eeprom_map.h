...
#define PW_EEPROM_ADDR_NINTENDO \
    0x0000  // "nintendo" string as a magic marker. if rom does not find this at boot, it will consider the walker empty
            // and uninitialized
...
#define PW_EEPROM_ADDR_FACTORY_DATA_1 \
    0x0080  // factory-provided adc calibration data. (reliable data format, copy at 0x0180)
...
#define PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_1 \
    0x0083  // struct uniqueidentitydata. provisioned at game pairing time (reliable data format, copy at 0x0183)
#define PW_EEPROM_SIZE_UNIQUE_IDENTITY_DATA_1 40
#define PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_CHK_1 \
    (PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_1 + PW_EEPROM_SIZE_UNIQUE_IDENTITY_DATA_1)
#define PW_EEPROM_ADDR_LCD_COMMANDS_1 \
    0x00ac  // struct lcdconfigcmds. provisioned at game pairing time (reliable data format, copy at 0x01ac)
...
#define PW_EEPROM_ADDR_IDENTITY_DATA_1 \
    0x00ed  // struct identitydata. provisioned at walk start time (reliable data format, copy at 0x01ed)
...
#define PW_EEPROM_ADDR_HEALTH_DATA_1 \
    0x0156  // struct healthdata. provisioned at walk start time (reliable data format, copy at 0x0256)
...
#define PW_EEPROM_ADDR_COPY_MARKER_1 \
    0x016f  // struct copymarker. used at walk init time (reliable data format, copy at 0x26f)
...
#define PW_EEPROM_ADDR_FACTORY_DATA_2 \
    0x0180  // factory-provided adc calibration data. (reliable data format, copy at 0x0080)
...
#define PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_2 \
    0x0183  // struct uniqueidentitydata. provisioned at game pairing time (reliable data format, copy at 0x0083)
#define PW_EEPROM_SIZE_UNIQUE_IDENTITY_DATA_2 40
#define PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_CHK_2 \
    (PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_2 + PW_EEPROM_SIZE_UNIQUE_IDENTITY_DATA_2)
#define PW_EEPROM_ADDR_LCD_COMMANDS_2 \
    0x01ac  // struct lcdconfigcmds. provisioned at game pairing time (reliable data format, copy at 0x00ac)
...
#define PW_EEPROM_ADDR_IDENTITY_DATA_2 \
    0x01ed  // struct identitydata. provisioned at walk start time (reliable data format, copy at 0x00ed)
...
#define PW_EEPROM_ADDR_HEALTH_DATA_2 \
    0x0256  // struct healthdata. provisioned at walk start time (reliable data format, copy at 0x0156)
...
#define PW_EEPROM_ADDR_COPY_MARKER_2 \
    0x026f  // struct copymarker. used at walk init time (reliable data format, copy at 0x16f)
...
#define PW_EEPROM_ADDR_IMG_CHAR_ZERO  (PW_EEPROM_ADDR_IMG_DIGITS + 0 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_ONE   (PW_EEPROM_ADDR_IMG_DIGITS + 1 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_TWO   (PW_EEPROM_ADDR_IMG_DIGITS + 2 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_THREE (PW_EEPROM_ADDR_IMG_DIGITS + 3 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_FOUR  (PW_EEPROM_ADDR_IMG_DIGITS + 4 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_FIVE  (PW_EEPROM_ADDR_IMG_DIGITS + 5 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_SIX   (PW_EEPROM_ADDR_IMG_DIGITS + 6 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_SEVEN (PW_EEPROM_ADDR_IMG_DIGITS + 7 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_EIGHT (PW_EEPROM_ADDR_IMG_DIGITS + 8 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_NINE  (PW_EEPROM_ADDR_IMG_DIGITS + 9 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_COLON (PW_EEPROM_ADDR_IMG_DIGITS + 10 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_DASH  (PW_EEPROM_ADDR_IMG_DIGITS + 11 * PW_EEPROM_SIZE_IMG_CHAR)
#define PW_EEPROM_ADDR_IMG_CHAR_SLASH (PW_EEPROM_ADDR_IMG_DIGITS + 12 * PW_EEPROM_SIZE_IMG_CHAR)
...
#define PW_EEPROM_ADDR_IMG_CARD_SUITS \
    0x04b8  // card faces: heart, spade, diamond, club, 8x8 each (used for "stamp" reception)
...
#define PW_EEPROM_ADDR_IMG_ARROWS \
    0x04f8  // arrows (up down left right), each in 3 configs (normal, offset, inverted) 8x8 each
...
#define PW_EEPROM_ADDR_IMG_MORE_MESSAGE \
    0x0638  // symbol for "have more message" in the bottom right of messages. orred into last 8 columns (thus 16
            // bytes). applied after 0x0648
#define PW_EEPROM_SIZE_IMG_MORE_MESSAGE 16
#define PW_EEPROM_ADDR_IMG_MORE_MESSAGES \
    0x0648  // symbol for "have more messages" in the bottom right of messages. each byte here is anded with each col of
            // last 8 in the message. both bitplanes (so you can make it black or keep as is). applied before 0x0638
...
#define PW_EEPROM_ADDR_IMG_TALK_FACES \
    0x0670  // large talk bubbles from bottom right with pokemon feeling icon (exclamation, heart, music note, smile,
            // neutral face, ellipsis) 24x16 each, 6 of them
...
#define PW_EEPROM_ADDR_IMG_TALK_EXCLAMATION \
    0x08b0  // large talk bubble from bottom left with exclamation point in it 24x16
...
#define PW_EEPROM_ADDR_IMG_RADAR_BUBBLE_THREE \
    0x1df0                                        // word bubble with three exclamation points (for poke hunting) 16x16
#define PW_EEPROM_SIZE_IMG_RADAR_BUBBLE_THREE 64  // TODO: dmitry typo 0x1e20 -> 0x1e2f
#define PW_EEPROM_ADDR_IMG_RADAR_CLICK \
    0x1e30  // three lines radiating from bottom left (for bush we just clicked) 16x16
...
#define PW_EEPROM_ADDR_ROUTE_ITEMS     (PW_EEPROM_ADDR_ROUTE_INFO + 0x8c)
#define PW_EEPROM_SIZE_ROUTE_ITEMS     (10 * 2)
...
#define PW_EEPROM_ADDR_IMG_POKEMON_SMALL_ANIMATED \
    0x91be  // current pokemon animated sprite for "held items and pokemon" screen, fights, etc. 32 x 24 x 2 frames
#define PW_EEPROM_SIZE_IMG_POKEMON_SMALL_ANIMATED       384
#define PW_EEPROM_SIZE_IMG_POKEMON_SMALL_ANIMATED_FRAME 192
#define PW_EEPROM_ADDR_IMG_POKEMON_SMALL_ANIMATED_FRAME1 \
    (PW_EEPROM_ADDR_IMG_POKEMON_SMALL_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_POKEMON_SMALL_ANIMATED_FRAME2 \
    (PW_EEPROM_ADDR_IMG_POKEMON_SMALL_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_POKEMON_LARGE_ANIMATED \
    0x933e  // current pokemon large nimated sprite for main screen 64 x 48 x 2 frames
#define PW_EEPROM_SIZE_IMG_POKEMON_LARGE_ANIMATED       1536
#define PW_EEPROM_SIZE_IMG_POKEMON_LARGE_ANIMATED_FRAME 768
#define PW_EEPROM_ADDR_IMG_POKEMON_LARGE_ANIMATED_FRAME1 \
    (PW_EEPROM_ADDR_IMG_POKEMON_LARGE_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_POKEMON_LARGE_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_POKEMON_LARGE_ANIMATED_FRAME2 \
    (PW_EEPROM_ADDR_IMG_POKEMON_LARGE_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_POKEMON_LARGE_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_TEXT_POKEMON_NAME 0x993e  // cur pokemon name image 80x16
#define PW_EEPROM_SIZE_TEXT_POKEMON_NAME 320
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED \
    0x9a7e  // route available pokemon selected by the same animated small sprites  32 x 24 x 2 frames x 3 pokemon
...
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P1_FRAME1 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P1_FRAME2 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P2_FRAME1 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 2 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P2_FRAME2 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 3 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P3_FRAME1 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 4 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED_P3_FRAME2 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_SMALL_ANIMATED + 5 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_LARGE_ANIMATED \
    0x9efe  // large animated image (like at 0x933e) but of the third (option c) available pokemon on this route. used
            // for "joined your walk" situation 64 x 48 x 2 frame
...
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_LARGE_ANIMATED_P3_FRAME1 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_LARGE_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_LARGE_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_LARGE_ANIMATED_P3_FRAME2 \
    (PW_EEPROM_ADDR_IMG_ROUTE_POKEMON_LARGE_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_ROUTE_POKEMON_LARGE_ANIMATED_FRAME)
...
#define PW_EEPROM_ADDR_TEXT_POKEMON_NAME_P1 \
    (PW_EEPROM_ADDR_TEXT_POKEMON_NAMES + 0 * PW_EEPROM_SIZE_TEXT_POKEMON_NAMES_SINGLE)
#define PW_EEPROM_ADDR_TEXT_POKEMON_NAME_P2 \
    (PW_EEPROM_ADDR_TEXT_POKEMON_NAMES + 1 * PW_EEPROM_SIZE_TEXT_POKEMON_NAMES_SINGLE)
#define PW_EEPROM_ADDR_TEXT_POKEMON_NAME_P3 \
    (PW_EEPROM_ADDR_TEXT_POKEMON_NAMES + 2 * PW_EEPROM_SIZE_TEXT_POKEMON_NAMES_SINGLE)
...
#define PW_EEPROM_ADDR_RECEIVED_BITFIELD \
    0xb800  // bitfield of special things received. 0x01 - \"heart\" stamp received, 0x02 - \"spade\" stamp received,
            // 0x04 - \"diamond\" stamp received, 0x08 - \"club\" stamp received, 0x10 - \"special map\" received, 0x20
            // - walker contains an event pokemon (gifted or caught), 0x40 - walker contains event item (gifted or
            // dowsed), 0x80 - walker has received a \"special route\"
// #define PW_EEPROM_ADDR_0xb801 0xb801  // unused
// #define PW_EEPROM_SIZE_0xb801 3
// #define PW_EEPROM_ADDR_0xb804 0xb804  // data for "special map received". format unknown. possibly used by the ds
// games, but no evidence of this found in the games. #define PW_EEPROM_SIZE_0xb804 576
//  TODO: multiple columns
#define PW_EEPROM_ADDR_EVENT_POKEMON_BASIC_DATA \
    0xba44  // gifted event poke, or radar-caught event poke, basic data. struct PokemonSummary
...
#define PW_EEPROM_ADDR_IMG_EVENT_POKEMON_SMALL_ANIMATED_FRAME1 \
    (PW_EEPROM_ADDR_IMG_EVENT_POKEMON_SMALL_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_EVENT_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_EVENT_POKEMON_SMALL_ANIMATED_FRAME2 \
    (PW_EEPROM_ADDR_IMG_EVENT_POKEMON_SMALL_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_EVENT_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_TEXT_EVENT_POKEMON_NAME 0xbc00  // name image 80x16
#define PW_EEPROM_SIZE_TEXT_EVENT_POKEMON_NAME 320
// TODO: multiple columns
#define PW_EEPROM_ADDR_EVENT_ITEM \
    0xbd40  // gifted event item, or dowsed event item, item data. 6 bytes of zeroes, then u16 item, LE
...
#define PW_EEPROM_ADDR_SPECIAL_POKEMON_BASIC_DATA \
    0xbf08  // special route-available pokemon basic data. struct pokemonsummary
#define PW_EEPROM_SIZE_SPECIAL_POKEMON_BASIC_DATA 16
#define PW_EEPROM_ADDR_SPECIAL_POKEMON_EXTRA_DATA \
    0xbf18  // special route-available pokemon extra data. struct eventpokeextradata
...
#define PW_EEPROM_ADDR_SPECIAL_POKEMON_PERCENT_CHANCE \
...
#define PW_EEPROM_ADDR_SPECIAL_ITEM_PERCENT_CHANCE \
...
#define PW_EEPROM_ADDR_IMG_SPECIAL_POKEMON_SMALL_ANIMATED \
    0xbf7c  // special route pokemon animates small sprite. 32 x 24 x 2 frames. should be 0x180 bytes big, but it 0x170.
            // no idea why but confirmed
...
#define PW_EEPROM_ADDR_IMG_SPECIAL_POKEMON_SMALL_ANIMATED_FRAME1 \
    (PW_EEPROM_ADDR_IMG_SPECIAL_POKEMON_SMALL_ANIMATED + 0 * PW_EEPROM_SIZE_IMG_SPECIAL_POKEMON_SMALL_ANIMATED_FRAME)
#define PW_EEPROM_ADDR_IMG_SPECIAL_POKEMON_SMALL_ANIMATED_FRAME2 \
    (PW_EEPROM_ADDR_IMG_SPECIAL_POKEMON_SMALL_ANIMATED + 1 * PW_EEPROM_SIZE_IMG_SPECIAL_POKEMON_SMALL_ANIMATED_FRAME)
...
#define PW_EEPROM_ADDR_IMG_SPECIAL_ROUTE_IMAGE \
    0xc83c  // special routes's large image for home screen, like 0x8fbe is for a normal route 32x24
...
#define PW_EEPROM_ADDR_TEAM_DATA_STRUCT \
    0xcc00  // struct teamdata on our whole team, so that any walkers we peer play with transfer it to their ds game and
            // we can be battled in the trainer house
#define PW_EEPROM_SIZE_TEAM_DATA_STRUCT 548
// #define PW_EEPROM_ADDR_0xce24 0xce24  // also written at walk start time as part of the above. probably just to keep
// the write a multiple of 0x80 bytes #define PW_EEPROM_SIZE_0xce24 92 #define PW_EEPROM_ADDR_0xce80 0xce80  // unused
// #define PW_EEPROM_SIZE_0xce80 8
#define PW_EEPROM_ADDR_0xce88 \
...
#define PW_EEPROM_ADDR_0xce8a \
    0xce8a  // current watts written to eeprom by cmd 0x20 before replying (likely so remote can read them directly).
            // u16 be
#define PW_EEPROM_SIZE_0xce8a 2
#define PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY \
    0xce8c  // 3x route-available pokemon we've caught so far. 3x struct pokemonsummary
#define PW_EEPROM_SIZE_CAUGHT_POKEMON_SUMMARY        48
#define PW_EEPROM_SIZE_CAUGHT_POKEMON_SUMMARY_SINGLE 16
#define PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY0 \
    (PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY + 0 * PW_EEPROM_SIZE_CAUGHT_POKEMON_SUMMARY_SINGLE)
#define PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY1 \
    (PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY + 1 * PW_EEPROM_SIZE_CAUGHT_POKEMON_SUMMARY_SINGLE)
#define PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY2 \
    (PW_EEPROM_ADDR_CAUGHT_POKEMON_SUMMARY + 2 * PW_EEPROM_SIZE_CAUGHT_POKEMON_SUMMARY_SINGLE)
#define PW_EEPROM_ADDR_OBTAINED_ITEMS \
    0xcebc  // 3x route-available items we've dowsed so far. 3x {u16 le item, u16 le unused}
...
#define PW_EEPROM_ADDR_PEER_PLAY_ITEMS \
    0xcec8  // 10x route-available items we've been gifted by peer play. 3x {u16 le item, u16 le unused}
...
#define PW_EEPROM_ADDR_HISTORIC_STEP_COUNT \
    0xcef0  // historic step count per day. u32 each, be, [0] is yesterday, [1] is day before, etc...
#define PW_EEPROM_SIZE_HISTORIC_STEP_COUNT 28
#define PW_EEPROM_ADDR_EVENT_LOG \
    0xcf0c  // event log. circularly-written, displayed in time order. 24x struct eventlogitem
...
#define PW_EEPROM_ADDR_SCENARIO_STAGING_AREA \
    0xd700  // scenario data written here before walk start action. everything that 0x8F00-0xB7FF would have
#define PW_EEPROM_SIZE_SCENARIO_STAGING_AREA 0x2800
#define PW_EEPROM_ADDR_CURRENT_PEER_TEAM_DATA \
    0xdc00  // current peer play peer. struct teamdata. uploaded as part of peer play. later shifted to index [0] at
            // 0xde24 list of peers
#define PW_EEPROM_SIZE_CURRENT_PEER_TEAM_DATA 548
#define PW_EEPROM_ADDR_MET_PEER_DATA \
    0xde24  // peers we've met. for battle house info. newest element is first. 10x struct teamdata
...
#define PW_EEPROM_ADDR_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL \
    0xf400  // peer play temporary data about peer, medium pokemon animated image of pokemon we are peer-playing with
            // (never erased) 32x24 x 2 frames
...
#define PW_EEPROM_ADDR_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL_FRAME1 \
    (PW_EEPROM_ADDR_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL +         \
        0 * PW_EEPROM_SIZE_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL_FRAME)
#define PW_EEPROM_ADDR_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL_FRAME2 \
    (PW_EEPROM_ADDR_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL +         \
        1 * PW_EEPROM_SIZE_IMG_CURRENT_PEER_POKEMON_ANIMATED_SMALL_FRAME)
#define PW_EEPROM_ADDR_TEXT_CURRENT_PEER_POKEMON_NAME \
    0xf580  // rendered text name of pokemon we are peer-playing with 80x16
