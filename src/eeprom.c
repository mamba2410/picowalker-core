...
void pw_eeprom_reset(bool clear_events, bool clear_steps) {
    ...
    pw_eeprom_reliable_read(PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_1, PW_EEPROM_ADDR_UNIQUE_IDENTITY_DATA_2,
        (uint8_t *)(&walker_info_cache.identity_data), sizeof(unique_identity_data_t));
...
void pw_eeprom_write_health_data(health_data_t *hd_orig) {
    ...
    pw_eeprom_reliable_write(
        PW_EEPROM_ADDR_HEALTH_DATA_1, PW_EEPROM_ADDR_HEALTH_DATA_2, (uint8_t *)(&hd), sizeof(health_data_t));
}
...
void pw_eeprom_write_walker_info(walker_info_t *wi_orig) {
    ...
    pw_eeprom_reliable_write(
        PW_EEPROM_ADDR_IDENTITY_DATA_1, PW_EEPROM_ADDR_IDENTITY_DATA_2, (uint8_t *)(&wi), sizeof(walker_info_t));
}
